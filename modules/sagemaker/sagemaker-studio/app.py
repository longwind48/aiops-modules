...
stack = SagemakerStudioStack(
    ...
    ml_engineer_users=app_settings.parameters.ml_engineer_users,
    ml_engineer_instance_type=app_settings.parameters.ml_engineer_instance_type,
    ml_engineer_image_name=app_settings.parameters.ml_engineer_image_name,
    ml_engineer_image_version=app_settings.parameters.ml_engineer_image_version,
    ml_engineer_storage_gb=app_settings.parameters.ml_engineer_storage_gb,
    ...
    value=stack.to_json_string(
        {
            ...
            "MlEngineerRoleArn": stack.sm_roles.ml_engineer_role.role_arn,
